...
const Login = () => {
  ...
  return (
      <form onSubmit={onSubmitHandler} className='flex flex-col items-center w-[90%] sm:max-w-96 m-auto mt-14 gap-4 text-gray-800'>
        ...
        <button className='bg-craft-brown hover:bg-craft-rust text-white font-light px-8 py-2 mt-4 rounded transition-colors duration-300'>{currentState === 'Login'?'Sign In':'Sign Up'}</button>
      </form>
  )
}
