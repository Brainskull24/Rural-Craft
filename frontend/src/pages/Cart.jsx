...
const Cart = () => {
  ...
  return (
    <div className="border-t-2 border-craft-tan pt-14">
        ...
        <div className="w-full sm:w-[450px]">
          ...
          <div className="w-full text-end">
            <button
              ...
              className="bg-craft-brown hover:bg-craft-rust text-white text-sm my-8 px-8 py-3 rounded transition-colors duration-300"
            >
              PROCEED TO CHECKOUT
            </button>
          </div>
